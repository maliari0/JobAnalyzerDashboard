...
- Create Angular project with ng: `ng new jobanalyzerdashboard.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`jobanalyzerdashboard.client.esproj`).
